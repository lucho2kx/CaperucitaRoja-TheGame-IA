...
public class CaperucitaRojaPerception extends Perception {
	...
	// Posición de Caperucita Roja en el Mapa(i, j)
	private int[] posicionCaperucitaRoja;
	// Posición de Lobo Feroz en el Mapa(i, j)
    ...
    public void initPerception(Agent agentIn, Environment environmentIn) {
        ...
        // Se obtiene la posición de Lobo Feroz
        ...
        // Se obtienen las líneas de vistas en todos los puntos cardinales
