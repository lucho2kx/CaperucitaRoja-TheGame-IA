...
public class EstadoAmbiente extends EnvironmentState {
  ...
  public EstadoAmbiente() {
    ...
    /*
     * // posicionLoboFeroz = initData0; // posicionArboles = initData1; // mapa =
     * initData2; // cantidadDulcesMapa = initData3; // posicionCampoFlores =
     * initData4; // posicionCaperucitaRoja = initData5; // vidasCaperucitaRoja =
     * initData6;
     */
    this.initState();
  }
  ...
  public void initState() {
    ...
    mapa.makeMapa1();
    // Posici�n inicial de Caperucita Roja en el mapa
    posicionCaperucitaRoja = new int[1];
    posicionCaperucitaRoja[0] = 5;
    posicionCaperucitaRoja[1] = 11;
    // Posici�n inicial de Lobo Feroz en el mapa
