...
public class TomarDulcesIrSur extends SearchAction {
  ...
  public SearchBasedAgentState execute(SearchBasedAgentState s) {
    ...
    // +cantidadDulcesLineaVista; posicionCaperucitaRoja()
  ...
  public EnvironmentState execute(AgentState ast, EnvironmentState est) {
    ...
    if (mapa[posicionCaperucitaRoja[0]][posicionCaperucitaRoja[1] + 1] != 3) {
      ...
      while ((j < mapa[0].length) && (mapa[posicionCaperucitaRoja[0]][j] != 3)) {
        ...
        if (mapa[posicionCaperucitaRoja[0]][j] == 1) {
          mapa[posicionCaperucitaRoja[0]][j] = 2;
          int mapaAmbiente[][] = estadoAmbiente.getmapa();
          mapaAmbiente[posicionCaperucitaRoja[0]][j] = 0;
