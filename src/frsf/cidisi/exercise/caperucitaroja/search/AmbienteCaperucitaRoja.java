...
public class AmbienteCaperucitaRoja extends Environment {
  ...
  public boolean agentFailed(Action actionReturned) {
    ...
    // 1- Agregar el estado del ambiente el atributo que nos indica falla(energ�a)
    // 2- Agregar un operador que se denomine "apagar" (que vendr� en
    // "actionReturned")
    // 3- Modificar GoalBasedAgentSimulator para que pase el AgentState en lugar de
    // Action
